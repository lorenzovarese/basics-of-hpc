...
namespace data
{
    ...
    void SubDomain::init(int mpi_rank, int mpi_size, Discretization &discretization)
    {
        ...
        int dims[2] = {0, 0};
        // compute number of partitions in each dimension
        ...
        int periods[2] = {0, 0};
        MPI_Comm comm_cart;
        // create the communicator with cartesian topology
        ...
        // determine rank of neighbour_south neighbour_north neighbour_east neighbour_west
